...
const SignIn = () => {
    ...
    return (
        <div className="py-20   mx-auto ">
            <SharedHeadings heading={'Login Now!!'} />
            <div className="flex flex-col lg:flex-row items-center justify-around  mx-auto ">
                ...
                >
                    <div className="py-10 flex flex-col items-center">
                        ...
                        <p>Please login to explore the insights</p>
                    </div>
                    <form onSubmit={handleSubmit} className="card-body">
                        ...
                        <div className="form-control mt-6">
                            <button className="btn bg-[#FB88B4] text-white">Login</button>
                        </div>
                    </form>
                    <div className="divider">OR
                        Login with</div>
                    <div className="flex flex-col py-10 items-center">
                        <button onClick={handleGoogleSignIn} className="btn bg-[#FB88B4] text-white"><FaGoogle />Google </button>
                    </div>
